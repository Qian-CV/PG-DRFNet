...
default_hooks = dict(
    checkpoint=dict(type='CheckpointHook', interval=interval, max_keep_ckpts=6, save_best='auto', rule='greater'))
work_dir = './work_dirs/ssdd/rtmdet/rotated_rtmdet_m_ch192-12x-ssdd-4layers-guidancehead-new/'
