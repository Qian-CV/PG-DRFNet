...
model = dict(
    ...
    bbox_head=dict(
        ...
        query_layer_train=[1, 2, 3],  # 添加了索引层，找小目标的层
        small_object_scale=[[0, 32], [0, 64], [0, 128]],  # 添加了小目标范围
        small_center_dis_coeff=[1., 1., 1.],  # 添加了小目标中心
        query_loss_gammas=[1.2, 1.2, 1.2],  # 添加了损失函数超参数
        query_loss_weights=[10., 10., 10.],  # 添加了损失函数超参数
...
work_dir = './work_dirs/ablation_study/A_study3/test4_3PGH/rotated_rtmdet_m_ch192-12x-vedai-4layers-guidancehead*3/'
