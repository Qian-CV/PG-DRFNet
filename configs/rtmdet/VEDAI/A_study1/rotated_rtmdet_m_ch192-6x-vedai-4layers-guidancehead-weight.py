...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_query_weight=0,  # 为了平横损失差距，对query部分损失缩放
...
work_dir = './work_dirs/ablation_study/A_study1/test2/rotated_rtmdet_m_ch192-6x-vedai-4layers-guidancehead-weight[1.0,2.6,1.2,1.0]/'
