_base_ = ['../../rotated_rtmdet/_base_/default_runtime.py', '../../rotated_rtmdet/_base_/schedule_6x.py',
          '../../rotated_rtmdet/_base_/dota_rr.py']
...
model = dict(
    ...
    bbox_head=dict(
        ...
        small_object_scale=[[0, 128], [0, 256]],  # 添加了小目标范围
        ...
        loss_query_weight=0.5,  # 为了平横损失差距，对query部分损失缩放
...
work_dir = './work_dirs/rotated_rtmdet_guidance_m_4layers-6x-dota-gradient_accumulation/'
